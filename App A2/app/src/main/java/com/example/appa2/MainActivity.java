...
public class MainActivity extends AppCompatActivity {
    ...
    //final PackageInfo pi = pm.getInstalledPackages()
        ...
        permissionButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(MainActivity.this, CUSTOM_PERMISSION)
                    ...
                    intent.setComponent(new ComponentName("com.example.app3", "com.example.app3.MainActivity"));
    ...
    public void onRequestPermissionsResult(int code, String[] permissions, int[] grantResults) {
        ...
        if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            //After the receiver is registered, launch App A3
            Intent intent = new Intent();
            intent.setComponent(new ComponentName("com.example.app3", "com.example.app3.MainActivity"));
            startActivity(intent);
        } else {
